...
import com.ominimie.auth.util.MongoOffsetDateTimeReader;
import com.ominimie.auth.util.MongoOffsetDateTimeWriter;
...
@Configuration
@EnableMongoRepositories("com.ominimie.auth")
